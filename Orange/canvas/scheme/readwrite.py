...
def scheme_to_python(scheme, out_file):
    ...
    # Re-activate event listeners to populate widget_to_node
    for node in scheme.nodes:
    ...
    sorted_widgets = map(scheme.widget_manager.widget_for_node, sorted_nodes)

    # Generate python script, one module at a time
    import_set = set()
