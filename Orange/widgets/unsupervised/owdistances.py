...
from Orange.widgets.unsupervised.utils import (
    MetricDefs, EuclideanNormalized, Euclidean, ManhattanNormalized,
    Manhattan, Mahalanobis, Hamming, Cosine, Pearson, PearsonAbsolute,
    Spearman, SpearmanAbsolute, Jaccard
)
