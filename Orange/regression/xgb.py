...
class XGBRegressor(XGBBase, Learner, _FeatureScorerMixin):
    ...
    def __init__(self, max_depth=6, learning_rate=0.3, n_estimators=100,
                 ...
                 booster="gbtree", tree_method="exact", n_jobs=0, gamma=0,
                 min_child_weight=1, max_delta_step=0, subsample=1,
                 colsample_bytree=1, colsample_bylevel=1, colsample_bynode=1,
                 reg_alpha=0, reg_lambda=1, scale_pos_weight=1, base_score=0.5,
                 random_state=0, missing=np.nan, num_parallel_tree=1,
                 monotone_constraints=(), interaction_constraints="",
                 importance_type="gain", gpu_id=-1, validate_parameters=1,
                 preprocessors=None):
...
class XGBRFRegressor(XGBBase, Learner, _FeatureScorerMixin):
    ...
    def __init__(self, max_depth=6, learning_rate=1, n_estimators=100,
                 verbosity=None, objective="reg:squarederror",
                 booster="gbtree", tree_method="exact", n_jobs=0, gamma=0,
                 min_child_weight=1, max_delta_step=0, subsample=0.8,
                 colsample_bytree=1, colsample_bylevel=1, colsample_bynode=0.8,
                 reg_alpha=0, reg_lambda=1e-5, scale_pos_weight=1,
                 base_score=0.5, random_state=0, missing=np.nan,
                 num_parallel_tree=1, monotone_constraints=(),
                 interaction_constraints="", importance_type="gain", gpu_id=-1,
                 validate_parameters=1, preprocessors=None):
        super().__init__(max_depth=max_depth, learning_rate=learning_rate,
                         n_estimators=n_estimators, verbosity=verbosity,
                         objective=objective, booster=booster,
                         tree_method=tree_method, n_jobs=n_jobs, gamma=gamma,
