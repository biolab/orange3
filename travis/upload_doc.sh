...
mkdir doc/build/orange3doc
ln -s `pwd`/doc/data-mining-library/build/html doc/build/orange3doc/data-mining-library
ln -s `pwd`/doc/development/build/html doc/build/orange3doc/development
ln -s `pwd`/doc/visual-programming/build/html doc/build/orange3doc/visual-programming
